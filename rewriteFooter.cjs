      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              ...
              <span className="font-bold text-xl text-white">E-Lawyers <span className="text-emerald-500">Bangladesh</span></span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li><Link to="/about" className="hover:text-emerald-400 transition-colors">About E-Lawyers</Link></li>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <span className="text-[11px] uppercase font-bold tracking-widest text-slate-500">© {new Date().getFullYear()} E-Lawyers Bangladesh</span>
