...
const replaceCode = `import { useState, useEffect, useRef } from 'react';
...
fs.writeFileSync('src/components/ReadAloudButton.tsx', replaceCode);
console.log('ReadAloudButton patched');
