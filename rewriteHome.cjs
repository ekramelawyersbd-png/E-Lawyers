...
import { ArrowRight, BookOpen, Calculator, FileText, Landmark, LineChart, MessageSquare, Search, Scale, Briefcase, FileSignature, Users, BookMarked, Download, Calendar as CalendarIcon, ArrowUpRight } from 'lucide-react';
        ...
        <div className="bg-slate-900 rounded-3xl p-8 md:p-16 relative overflow-hidden flex flex-col justify-end text-white border border-slate-800 shadow-xl">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight max-w-2xl">
